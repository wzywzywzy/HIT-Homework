...
(function ($) {
  ...
  Drupal.behaviors.hit_front = {
    attach: function (context, settings) {
      ...
      $('.mm-navbar__title', context).html('导航');

      /*
       * Masonry
       * caption 因为没有包含在colorbox里面，通过trigger模拟触发
       */
...
(function ($) {
    Drupal.behaviors.expander = {
        init: function (e, setting) {
            ...
            //创建切换按钮
            var expander = $('<div class="expander"><div class="more-less"><span>更多</span><span>收起</span></div></div>');
...
(function($) {
  'use strict';
  //++++++++++++++++
  // selectric初始化，注意不能够全局使用，drupal模块中有多级下拉
  //++++++++++++++++
  // $('select').selectric();
